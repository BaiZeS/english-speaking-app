...
|---|---|
| 任何手机（默认） | `http://118.89.58.84:5173/api/v1/`——**v2.2.1 起 debug 与 release 的 APK 默认值都是它**（生产端点，开箱即用） |
| 模拟器（连本地 dev） | 「设置」页改成 `http://10.0.2.2:8000/api/v1/`（dev 栈绑 `127.0.0.1` 也照样可达——`10.0.2.2` NAT 到宿主 loopback） |
